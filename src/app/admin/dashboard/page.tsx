        ...
        <div className="space-y-4">
            ...
            >
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    <InputField
                        label="Título"
                        value={(data as typeof data & { projectsTitle?: string }).projectsTitle ?? "Projetos"}
                        onChange={(v) => setData((prev) => ({ ...prev, projectsTitle: v }))}
                    />
                    <InputField
                        label="Subtítulo"
                        value={(data as typeof data & { projectsSubtitle?: string }).projectsSubtitle ?? "Trabalhos selecionados do universo iGaming"}
                        onChange={(v) => setData((prev) => ({ ...prev, projectsSubtitle: v }))}
                    />
                </div>
            </div>
